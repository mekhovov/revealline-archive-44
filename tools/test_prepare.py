...
class CommittedMetadataTests(unittest.TestCase):
    def test_exact_original_metadata_and_source_qualification(self):
        ...
        self.assertEqual((lock['expectedFiles'], lock['expectedBytes']), (885, 423018833))
        self.assertEqual([r['version'] for r in lock['releases']], ['v0.79.1'])
        self.assertEqual(inventory['base'], 'https://mekhovov.github.io/revealline-archive-44/')
        release = lock['releases'][0]
        self.assertEqual(release['tagObject'], '753c8ccd0cc73a7b93cb275c0b7283b367165c24')
        self.assertEqual(release['sourceRevision'], '9876f995bc155638cf9dcc62b5d6e1daec963b27')
        self.assertEqual(release['sourceTree'], 'aae498df146ed7dccb1be0f15258fa3717ddf0a5')
        self.assertEqual(release['sourceQualification'], {'bytes': 108850, 'sha256': '7a35210aa25d6c9cd2c5b1f41511f7458db8c37f263958ff92ec70832e45e876'})
        cohort = [r for r in inventory['files'] if r['path'].startswith('releases/v0.79.1/')]
        self.assertEqual((len(cohort), sum(r['bytes'] for r in cohort)), (882, 423017439))
